...
<form action="../../Actions/actionDestinos.php" method="POST" class="forms-sample">
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-10">
                                ...
                                <div class="card">
                                    <div class="card-header"><h3>Formulario de Cadastro de Destinos</h3></div>
                                    <div class="card-body">
                                    <?php
                                      $idLoja = "";
                                      ...
                                      if($_SESSION['user'][0]['nivel_acesso_fk'] == 4){
                                        $idLoja = $_SESSION['user'][0]['fk_login_loja'];
                                          ...
                                          foreach ($destinosController ->read($idLoja) as $d) {?>
                                             <input type="hidden" name="id_do_destino" value="<?=$d['id_destino']?>">
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Nome do destino</label>
                                                <input value="<?=$d['nome_destino']?>" type="text" name="nome_destino" class="form-control" id="exampleInputUsername1" placeholder="Ex: Beach Park...">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Endereco</label>
                                                <input value="<?=$d['endereco']?>" type="text" name="endereco" class="form-control" id="exampleInputUsername1" placeholder="Ex:  rua etc.. cep 8888888">
                                            </div>
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-8">
            <button type="Submit" class="btn btn-info btn-block" name="EditarDestino" value="CadastrarDestino">Cadastrar</button>
		</div>
		<div class="col-md-2">
		</div>
	</div>
