      ...
      <div class="card">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select class="form-control" id="select_vendedor">
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-lg-12 col-md-12">
                <h3 class="card-title" id="nome_pass">Todas as vendas</h3>
...
function gerarVendedores() {
  ...
  function valuesGraph() {
    ...
    axios.post('../../api2/controller.php', {
      ...
      myChart.update();
      tabela( $("#select_vendedor").val())
    })

  }

  function tabela(id_vendedor){
    axios.post('../../api2/controller.php', {
      action: "tabela-vendas-pdia",
      values: [
          id_vendedor
      ]
      ...
      for (var i = 0; i < response.data.length; i++) {
        tbody += `<tr>
                ...
                <td>` + response.data[i].qVendasPdia + ` Venda(as)</td>
                
                <td> ` + response.data[i].data + `  </td>

                </tr>`
      }
      document.getElementById("tbody_vendas-dia").innerHTML = tbody
    })
