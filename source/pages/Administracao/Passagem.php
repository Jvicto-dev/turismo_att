...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-2">
     <a href="Passagem-Adicionar.php"><button type="button" class="btn btn-outline-success">Adiconar Passagens</button></a>
		</div>
	</div>
</div>
              ...
              if($_SESSION['user'][0]['nivel_acesso_fk'] == 4){
                $idLoja = $_SESSION['user'][0]['fk_login_loja'];
                  ...
                  $idLoja = $_SESSION['user'][0]['id_login'];
                    ...
                    foreach ($passagens ->read($idLoja) as $p) {
                ?>
                <tr>
                <th scope = "row"><?= $p['nome_destino']; ?></th>
                
                <td><?= $p['nome_categoria']; ?></td>
                <td><?= $p['valor']; ?></td>
                   
                    <td>
                      <a href="../../pages/Administracao/Passagem-Editar.php?idPassagem=<?= $p['id_passagem']; ?>">
                      ...
                      <a href="#">
                        <button onclick="DeletarPassagem(<?= $p['id_passagem']; ?>)" type="button" class="btn btn-outline-danger">
