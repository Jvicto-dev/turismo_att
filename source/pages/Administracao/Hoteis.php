...
<div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                        <a href="Hoteis-Adicionar.php"><button type="button" class="btn btn-outline-success">Adicionar Hoteis</button></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                ...
                <?php
                   ...
                   if($_SESSION['user'][0]['nivel_acesso_fk'] == 4){
                    ...
                    ?>
                    <tr>
                        <th scope = "row"><?= $h['nome_hotel']; ?></th>
                    
                        <td>
                        <a href="../../pages/Administracao/Hoteis-Editar.php?idHotel=<?= $h['id_hotel']; ?>">
                        ...
                        <a href="#">
                            <button onclick="DeletarHotel(<?= $h['id_hotel']; ?>)" type="button" class="btn btn-outline-danger">
