                ...
                <div class="col-md-10">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>GERAÇÃO DE PDF DA VIAGEM - Pontos de encontro</h3>
                        </div>
                        <div class="card-body">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <button onclick="pdfInforsPontoEncontro()" type="Submit" class="btn btn-info btn-block" name="CadastrarDestino" value="CadastrarDestino">GERAR</button>
