...
<div class="main-content">
                ...
                <div class="col-md-10">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Editar Ponto de Encontro</h3>
                        </div>
                        <div class="card-body">

                            <input type="text" id="id_local" value="<?= $idLocal ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="edit_horario" type="time">
                            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8">
                <button type="Submit" onclick="update()" class="btn btn-info btn-block" name="" value="">Editar</button>
            </div>
            <div class="col-md-2">
            </div>
        </div>
...
<script>
    function read() {
        ...
        axios.post('../../api2/controller.php', {
            action: "read-ponto-encontro-one",
            values: [
                id_local
            ]
            ...
            for (var i = 0; i < response.data.length; i++) {
                ...
                hr = response.data[i].horario
            }
            $("#ponto_encontro").val(text)
            $("#edit_horario").val(hr)
        })
    }
    read()
