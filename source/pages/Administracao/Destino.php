...
<div class="main-content">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="Destino-Adicionar.php"><button type="button" class="btn btn-outline-success">Adicionar Destinos</button></a>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <table id="table" class="table">
                    ...
                    <tbody>
                        ...
                        foreach ($destinos->read($idLoja) as $d) {
                        ?>
                            <tr>
                                <th scope="row"><?= $d['nome_destino']; ?></th>
                                <td><?= $d['endereco']; ?></td>

                                <td>
                                    <a href="../../pages/Administracao/Destino-Editar.php?idDestino=<?= $d['id_destino']; ?>">
                                    ...
                                    <a href="#">
                                        <button onclick="DeletarDestino(<?= $d['id_destino']; ?>)" type="button" class="btn btn-outline-danger">
...
<?php
// resto das coisas depois da div principal 
