                     ...
                     <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                           <div class="state">
                              ...
                              <h3 class="text-success" id="vendas">25.609 Vendas </h3>
                              <p class="card-subtitle text-muted fw-500">Total de vendas em toda tragetoria</p>
                           </div>
                           <div class="state">
                              <h6>Valor Arrecadado</h6>
                              <h3 class="text-success" id="arrecadado">R$10000000</h3>
                              <p class="card-subtitle text-muted fw-500">Total Arrecadado em toda tragetoria</p>
                           </div>
