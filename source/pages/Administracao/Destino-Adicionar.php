                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nome_destino" class="form-control" id="exampleInputUsername1" placeholder="Ex: Beach Park...">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Endereco</label>
                                                <input type="text" name="endereco" class="form-control" id="exampleInputUsername1" placeholder="Ex:  rua etc.. cep 8888888">
                                            </div>
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-8">
            <button type="Submit" class="btn btn-info btn-block" name="CadastrarDestino" value="CadastrarDestino">Cadastrar</button>
		</div>
		<div class="col-md-2">
		</div>
	</div>
